                  ...
                  <ol className={styles.list_item_music}>
                    {
                      Array.from({ length: electro.workout.length  }).map((_, i) => (
                        <li key={i} className={styles.list_item_songs}>
                          <Card name={electro.workout[i].name} author={electro.workout[i].author} cover={electro.workout[i].cover} link={electro.workout[i].link} key={`item_electro_workouts_${i}`} />
                        </li>
                      ))
                    }
                  ...
                  <ol className={styles.list_item_music}>
                    {
                      Array.from({ length: electro.dance.length  }).map((_, i) => (
                        <li key={i} className={styles.list_item_songs}>
                          <Card name={electro.dance[i].name} author={electro.dance[i].author} cover={electro.dance[i].cover} link={electro.dance[i].link} key={`item_electro_dance_${i}`} />
                        </li>
                      ))
                    }
                  ...
                  <ol className={styles.list_item_music}>
                    {
                      Array.from({ length: electro.hard.length  }).map((_, i) => (
                        <li key={i} className={styles.list_item_songs}>
                          <Card name={electro.hard[i].name} author={electro.hard[i].author} cover={electro.hard[i].cover} link={electro.hard[i].link} key={`item_electro_hard_${i}`} />
                        </li>
                      ))
                    }
                  ...
                  <ol className={styles.list_item_music}>
                    {
                      Array.from({ length: electro.Dubstep.length  }).map((_, i) => (
                        <li key={i} className={styles.list_item_songs}>
                          <Card name={electro.Dubstep[i].name} author={electro.Dubstep[i].author} cover={electro.Dubstep[i].cover} link={electro.Dubstep[i].link} key={`item_electro_dubstep_${i}`} />
                        </li>
                      ))
                    }
                  ...
                  <ol className={styles.list_item_music}>
                    {
                      Array.from({ length: electro.trance.length  }).map((_, i) => (
                        <li key={i} className={styles.list_item_songs}>
                          <Card name={electro.trance[i].name} author={electro.trance[i].author} cover={electro.trance[i].cover} link={electro.trance[i].link} key={`item_electro_trance_${i}`} />
                        </li>
                      ))
                    }
                  ...
                  <ol className={styles.list_item_music}>
                    {
                      Array.from({ length: electro.deep.length  }).map((_, i) => (
                        <li key={i} className={styles.list_item_songs}>
                          <Card name={electro.deep[i].name} author={electro.deep[i].author} cover={electro.deep[i].cover} link={electro.deep[i].link} key={`item_electro_deep_${i}`} />
                        </li>
                      ))
                    }
                  ...
                  <ol className={styles.list_item_music}>
                    {
                      Array.from({ length: electro.after_party.length  }).map((_, i) => (
                        <li key={i} className={styles.list_item_songs}>
                          <Card name={electro.after_party[i].name} author={electro.after_party[i].author} cover={electro.after_party[i].cover} link={electro.after_party[i].link} key={`item_electro_after_party_${i}`} />
                        </li>
                      ))
                    }
